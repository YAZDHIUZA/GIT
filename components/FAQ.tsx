...
const FAQ = () => {
  ...
  const faqs = [
    {
      q: "ما هو منتج Vitalis Ataa Atabi3a ؟",
      a: "Vitalis plus  هو منتج طبيعي 100% يتكون من خليط مختار من الأعشاب الطبيعية والعسل، مصمم لدعم الطاقة والحيوية والصحة الجنسية للرجال والنساء."
    },
    {
    ...
    {
      q: "كيف أستخدم  Vitalis Ataa Atabi3a ?",
    ...
    },
    {
      ...
      a: "نعم! Vitalis Ataa Atabi3a   مصمم ليكون فعالاً للجنسين. يدعم الطاقة والحيوية والصحة العامة والجنسية للرجال والنساء على حد سواء."
    },
    {
      q: "كم مدة الشحن؟",
