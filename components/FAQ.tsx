...
const FAQ = () => {
  ...
  const faqs = [
    {
      q: "ما هو منتج Ataa Atabi3a ENERGY؟",
      a: "Ataa Atabi3a ENERGY هو منتج طبيعي 100% يتكون من خليط مختار من الأعشاب الطبيعية والعسل، مصمم لدعم الطاقة والحيوية والصحة الجنسية للرجال والنساء."
    },
    {
    ...
    {
      q: "كيف أستخدم Ataa Atabi3a ENERGY؟",
    ...
    },
    {
      ...
      a: "نعم! Ataa Atabi3a ENERGY مصمم ليكون فعالاً للجنسين. يدعم الطاقة والحيوية والصحة العامة والجنسية للرجال والنساء على حد سواء."
    },
    {
      q: "كم مدة الشحن؟",
